    ...
    <div className="login-container">
      <div className="login-left" aria-hidden>
        <div className="login-hero">
          <span className="login-badge">2025 release</span>
          <h1 className="login-hero-title">Voice AI – Workflow Callout</h1>
          <p className="login-hero-subtitle">
            Orchestrate real-time voice agents, route intents, and ship production-grade callouts with confident control.
          </p>
